...
<body>
  ...
  <footer>
    ...
    <p style="margin-top:.5rem;font-size:.8rem;color:#aaa;">Part of the data sovereignty toolkit: <a href="https://deletefreely.com" style="color:#aaa;">DeleteFreely</a> · <a href="https://ditchthemega.com" style="color:#aaa;">DitchTheMega</a></p>
  </footer>
</body>
</html>"""
